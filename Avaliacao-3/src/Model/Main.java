...
// mexendo com o items e empréstimo - alteração na Classe Débito de maneira a simplificar ....
...
//        Debito debito = new Debito(aluno, 2.00, true);
...
//        controleAluno.excluirAluno(aluno);
//          controleAluno.verificarAluno(aluno);
//        controleDebito.inserirDebito(debito);
//        controleDebito.verificarDebito(aluno);
//        controleDebito.excluirDebito(aluno);
//        controleDebito.verificarDebito(aluno);
//      controleTitulo.inserirTitulo(titulo);
//        controleTitulo.verificarTitulo(titulo);
//        controleTitulo.excluirTitulo(titulo);
//        controleTitulo.verificarTitulo(titulo);
...
//        controleExemplar.verificaExemplar(exemplar1);
//        controleExemplar.verificaExemplar(exemplar2);
//        controleExemplar.verificaExemplar(exemplar3);
